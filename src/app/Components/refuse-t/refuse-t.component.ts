...
@Component({
  selector: 'app-refuse-t',
  templateUrl: './refuse-t.component.html',
  styleUrls: ['./refuse-t.component.css']
})
export class RefuseTComponent implements OnInit {
