...
@Component({
  selector: 'app-ticket-prise',
  templateUrl: './ticket-prise.component.html',
  styleUrls: ['./ticket-prise.component.css']
})
export class TicketPriseComponent implements OnInit {
