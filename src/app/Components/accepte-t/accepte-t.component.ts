...
import { ValiderAccepteComponent } from '../valider-accepte/valider-accepte.component';

@Component({
  selector: 'app-accepte-t',
  templateUrl: './accepte-t.component.html',
  styleUrls: ['./accepte-t.component.css']
})
export class AccepteTComponent implements OnInit {
...
idTech:number=2;
  ...
  openDialog(row:any){
    ...
    this.dialog.open(ValiderAccepteComponent,{
      width:'55%',
      data:row
