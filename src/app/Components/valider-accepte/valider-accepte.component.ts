...
@Component({
  selector: 'app-valider-accepte',
  templateUrl: './valider-accepte.component.html',
  styleUrls: ['./valider-accepte.component.css']
})
export class ValiderAccepteComponent implements OnInit {
  ...
  equipeITlist$:Observable<any[]>;
   ...
   constructor( private formBuilder:FormBuilder,
     ...
     private dialogRef:MatDialogRef<ValiderAccepteComponent>){}
