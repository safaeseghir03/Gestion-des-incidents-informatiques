...
@Component({
  selector: 'app-voir-t',
  templateUrl: './voir-t.component.html',
  styleUrls: ['./voir-t.component.css']
})
export class VoirTComponent implements OnInit {
  idTicket:any
  titre:any
  ...
  constructor(
    ...
    private dialogRef:MatDialogRef<VoirTComponent>,
